...
import numpy as np
import os
from classifying_only_desired_log import is_important_log
...
def main():
    ...
    parser.add_argument('file_path', type=str, nargs='?', default="MeasurementDAQLog_20240730.log", help="Path to the log file")
    parser.add_argument('--line_limit', type=int, default=20000, help="Number of lines to process from the log file")
